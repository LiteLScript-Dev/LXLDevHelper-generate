...
---@param callback fun(player:Player,cmd:string) 事件回调
---@return boolean 是否添加成功
function mc.listen(event,callback)
end
...
---@param callback fun(player:Player,msg:string) 事件回调
---@return boolean 是否添加成功
function mc.listen(event,callback)
end
...
---@param callback fun(player:Player,entity:Entity) 事件回调
---@return boolean 是否添加成功
function mc.listen(event,callback)
end
...
---@param callback fun(player:Player,item:Item,block:Block) 事件回调
---@return boolean 是否添加成功
function mc.listen(event,callback)
end
...
---@param callback fun(player:Player,pos:IntPos) 事件回调
---@return boolean 是否添加成功
function mc.listen(event,callback)
end
