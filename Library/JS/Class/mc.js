...
/**
 * 娉ㄥ唽涓�涓柊鐨勭帺瀹跺懡浠�
 * @param {string} cmd 寰呮敞鍐岀殑鍛戒护
 * @param {string} description 鍛戒护鎻忚堪鏂囨湰
 * @param {(player:Player,args:Array@string)boolean} callback 娉ㄥ唽鐨勮繖涓懡浠よ鎵ц鏃讹紝鎺ュ彛鑷姩璋冪敤鐨勫洖璋冨嚱鏁�
 * @param {number} level 锛堝彲閫夊弬鏁帮級鍛戒护鐨勬敞鍐岀瓑绾э紝榛樿涓� 0 锛屽嵆鎵�鏈変汉閮藉彲浠ユ墽琛�
 * @returns {boolean} 鏄惁鎴愬姛娉ㄥ唽
 */
 ...
 * @param {string} cmd 寰呮敞鍐岀殑鍛戒护
 * @param {string} description 鍛戒护鎻忚堪鏂囨湰
 * @param {(args:Array@string)boolean} callback 娉ㄥ唽鐨勮繖涓懡浠よ鎵ц鏃讹紝鎺ュ彛鑷姩璋冪敤鐨勫洖璋冨嚱鏁�
 * @returns {boolean} 鏄惁鎴愬姛娉ㄥ唽
 */
 ...
 * @param {string} output 妯℃嫙浜х敓鐨勫懡浠よ緭鍑�
 * @returns {boolean} 鏄惁鎴愬姛鎵ц
 */
 ...
 * @param {(player:Player)function} callback 浜嬩欢鍥炶皟
 ...
 * @param {(player:Player,isSneaking:boolean)function} callback 浜嬩欢鍥炶皟
 * @returns {boolean} 鏄惁娣诲姞鎴愬姛
 */
 function listen(event,callback)
 ...
 * @param {(player:Player,item:Item)function} callback 浜嬩欢鍥炶皟
 * @returns {boolean} 鏄惁娣诲姞鎴愬姛
 */
 function listen(event,callback)
 ...
 * @param {(player:Player,block:Block)function} callback 浜嬩欢鍥炶皟
 * @returns {boolean} 鏄惁娣诲姞鎴愬姛
 */
 function listen(event,callback)
 ...
 * @param {(player:Player,slotNum:number,oldItem:Item,newItem:Item)function} callback 浜嬩欢鍥炶皟
 * @returns {boolean} 鏄惁娣诲姞鎴愬姛
 */
 function listen(event,callback)
 ...
 * @param {(player:Player,pos:FloatPos)function} callback 浜嬩欢鍥炶皟
 * @returns {boolean} 鏄惁娣诲姞鎴愬姛
 */
 function listen(event,callback)
 ...
 * @param {(player:Player,slotNum:number,item:Item)function} callback 浜嬩欢鍥炶皟
 * @returns {boolean} 鏄惁娣诲姞鎴愬姛
 */
 function listen(event,callback)
