 ...
 * @param {(player:Player,cmd:string)} callback 浜嬩欢鍥炶皟
 * @returns {boolean} 鏄惁娣诲姞鎴愬姛
 */
 static listen(event,callback)
 ...
 * @param {(player:Player,msg:string)} callback 浜嬩欢鍥炶皟
 * @returns {boolean} 鏄惁娣诲姞鎴愬姛
 */
 static listen(event,callback)
 ...
 * @param {(player:Player,entity:Entity)} callback 浜嬩欢鍥炶皟
 * @returns {boolean} 鏄惁娣诲姞鎴愬姛
 */
 static listen(event,callback)
 ...
 * @param {(player:Player,item:Item,block:Block)} callback 浜嬩欢鍥炶皟
 * @returns {boolean} 鏄惁娣诲姞鎴愬姛
 */
 static listen(event,callback)
 ...
 * @param {(player:Player,pos:IntPos)} callback 浜嬩欢鍥炶皟
 * @returns {boolean} 鏄惁娣诲姞鎴愬姛
 */
 static listen(event,callback)
